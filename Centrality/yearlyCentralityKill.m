...
%% load data
network = load('yearly_kill_adj.mat');
adjacency_kills = network.adjacency_kills;
...
for i=0:51
    ...
    g = graph(adjacency_kills{i+1}*adjacency_kills{i+1}');
...
% Adjust the layout
sgtitle('Top 10 terrorists hubs based on degree centrality kill network');
% Maximize the figure window
set(gcf, 'Position', get(0, 'Screensize'));
saveas(gcf, 'top10degcentkill.jpg');
...
% Adjust the layout
sgtitle('Top 10 terrorists hubs based on betweenness centrality kill network');
% Maximize the figure window
set(gcf, 'Position', get(0, 'Screensize'));
saveas(gcf, 'top10betcentkill.jpg');
...
% Adjust the layout
sgtitle('Top 10 terrorists hubs based on eigen centrality kill network');
% Maximize the figure window
set(gcf, 'Position', get(0, 'Screensize'));
saveas(gcf, 'top10eigcentkill.jpg');
...
% Adjust the layout
sgtitle('Top 10 terrorists hubs in last 20 years based on degree centrality kill network');
% Maximize the figure window
set(gcf, 'Position', get(0, 'Screensize'));
saveas(gcf, 'top10l20degcentkill.jpg');
...
% Adjust the layout
sgtitle('Top 10 terrorists hubs in last 20 years based on betweenness centrality kill network');
% Maximize the figure window
set(gcf, 'Position', get(0, 'Screensize'));
saveas(gcf, 'top10l20betcentkill.jpg');
...
% Adjust the layout
sgtitle('Top 10 terrorists hubs in last 20 years based on eigen centrality kill network');
% Maximize the figure window
set(gcf, 'Position', get(0, 'Screensize'));
saveas(gcf, 'top10l20eigcentkill.jpg');
